...
fn x25519_public_from_private(
    ...
    #[cfg(all(not(any(target_os = "ios", target_os = "tvos", target_os = "watchos")), target_arch = "arm"))]
    {
...
fn x25519_ecdh(
    ...
    #[cfg_attr(
        not(all(not(any(target_os = "ios", target_os = "tvos", target_os = "watchos")), target_arch = "arm")),
